...
$title = 'Сообщение об ошибке на сайте joy.by';
...
$comment =  substr(htmlspecialchars(trim($_POST['comment'])), 0, 100000);
                ...
                <body>
                <strong>Адрес страницы:</strong> '.$url.'
                <br/>
...
$to = 'application@jou.by';
# Email адрес, от кого пришло сообщение:
$mymail='apliyxa@yandex.ru';
# Вместо "yousite.ru" указжите имя вашего сайта: 
        $from = "From: =?windows-1251?B?". base64_encode("jou.by"). "?= < $mymail >\n";
